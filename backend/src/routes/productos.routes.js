...
import { listar, obtenerUno, crear, actualizar, toggleActivo } from '../controllers/productos.controller.js';
...
router.get('/:id', verifyToken, obtenerUno);     // detalle de un producto
